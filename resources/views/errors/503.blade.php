...
<body class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
        <div class="container-tight py-4">
            <div class="empty">
                <div class="empty-img"><img src="/img/error503.svg" height="128" alt="">
                </div>
                <p class="empty-title">Temporairement indisponible pour maintenance</p>
                <p class="empty-subtitle text-muted">
                    Désolé pour la gêne occasionnée, mais nous effectuons actuellement une maintenance. Nous reviendrons
                    bientôt en ligne !
                </p>
