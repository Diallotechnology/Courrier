...
<div class="col">
    ...
    <h2 class="page-title">
        <span class="text-truncate">Corbeille des sous structures</span>
    </h2>
</div>
@endsection
@section('content')
<x-table :rows="$rows">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <x-button-restore url="{{ url('substructure/restore/'.$row->id) }}" />
                <x-button-delete url="{{ url('substructure/delete/'.$row->id) }}" />
            </td>
        </tr>
        @empty
        <tr>
