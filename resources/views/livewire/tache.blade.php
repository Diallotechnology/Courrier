    ...
    <div class="col">
        <div class="mb-1">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Taches</a></li>
            </ol>
        </div>
        <h2 class="page-title">
            <span class="text-truncate">Liste des taches</span>
        </h2>
    </div>
    @endsection
    @section('content')
                ...
                <div class="col-md-12">
                    <div wire:ignore>
                        <x-select name="imputation_id" :required="false" label="liste des imputations ">
                            @foreach ($imp as $item)
                            <option @selected(old('imputation_id')==$item->id) value="{{ $item->id }}">imputation N°{{
                                $item->numero }}</option>
                            @endforeach
                        </x-select>
                    </div>
