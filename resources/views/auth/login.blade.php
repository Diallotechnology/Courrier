    ...
    <div class="col-lg">
        <div class="container-tight">
          <div class="text-center mb-4">
            <a href="." class="navbar-brand navbar-brand-autodark"><x-logo/></a>
          </div>
          <div class="card card-md">
            <div class="card-body">
              ...
              <form autocomplete="off" novalidate method="POST" action="{{ route('login') }}" >
                @csrf
                <div class="mb-3">
                    <x-input type="email" name="email" place="your@email.com" :messages="$errors->get('email')" :value="old('email')" autofocus autocomplete="username" />
                </div>
                <div class="mb-2">
                  ...
                  <div class="input-group input-group-flat">
                    <input type="password" class="form-control" name="password" placeholder="Votre mot de passe" autocomplete="current-password">
